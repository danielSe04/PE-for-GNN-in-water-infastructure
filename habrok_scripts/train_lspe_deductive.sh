...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=train-wdn-pe-lspe-deductive
#SBATCH --mem=128000
...
python main.py --task train --data_config "gigantic_dataset/arguments/train/data_deductive.yaml" --model_config "gigantic_dataset/arguments/train/model_lspe.yaml"
