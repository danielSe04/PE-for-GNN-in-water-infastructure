...
cd $TMPDIR
tar -xzf code.tar.gz
python main.py --task train --data_config "gigantic_dataset/arguments/train/data.yaml" --model_config "gigantic_dataset/arguments/train/model_lspe.yaml"
