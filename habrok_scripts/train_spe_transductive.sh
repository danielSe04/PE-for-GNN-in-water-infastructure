...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=train-wdn-pe-spe-transductive
#SBATCH --mem=128000
...
python main.py --task train --data_config "gigantic_dataset/arguments/train/data_transductive.yaml" --model_config "gigantic_dataset/arguments/train/model_spe_transductive.yaml"
