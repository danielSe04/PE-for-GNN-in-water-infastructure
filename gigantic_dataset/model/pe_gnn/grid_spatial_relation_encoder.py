# This file ic composed of classes and functions copied from the original PE-GNN implementation. See https://github.com/konstantinklemmer/pe-gnn
# The GridCellSpatialRelationEncoder can be used to calculate PE-GNN's geo-located positional encoding.
