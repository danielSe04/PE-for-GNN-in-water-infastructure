...
5. `aux_criterion` indicates whether there is an auxiliary learning task associated to the PE, and what criterion it uses ("mse", "morans-i", or "" to not use an auxiliary learning task).
